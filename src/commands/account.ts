...
const accountLinkCommand = defineCommand({
  ...
  args: {
    ...
    products: { type: "string", description: "Comma-separated premium products to ask for: sales_navigator, recruiter. Omit to ask for both. Classic LinkedIn and company pages are always included." },
